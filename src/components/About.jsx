          ...
          <div>
            ...
            <Reveal delay={0.08}>
              ...
              <p style={{ fontFamily: serif, fontSize: 'clamp(14px, 1.8vw, 20px)', lineHeight: 1.85, color: C.inkMid, marginBottom: 16 }}>
                At <a href="https://paystack.com" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecorationColor: C.ochre }}>Paystack</a> I've built systems that keep complex organisations running — treasury infrastructure across five African markets, a Microfinance Bank launched from regulatory approval to live operations, the compliance and operational architecture that makes scale possible. Through <a href="https://motitomi.notion.site" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecorationColor: C.ochre }}>Motitomi</a> I've built the spaces where people in this city can slow down, think, gather, and make things together.
              </p>
